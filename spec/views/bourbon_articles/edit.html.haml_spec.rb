...
describe "bourbon_articles/edit" do
  before(:each) do
  ...
  xit "renders the edit bourbon_article form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", bourbon_article_path(@bourbon_article), "post" do
